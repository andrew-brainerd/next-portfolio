...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <header className="relative bg-gradient-to-br from-brand-700 via-brand-600 to-brand-500 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-14 sm:py-18 text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-brand-100 text-base sm:text-lg lg:text-xl font-light max-w-2xl mx-auto">
