...
export const SignIn = ({ redirectRoute }: SignInProps) => {
  ...
  return (
    <div className="mt-[5%] flex flex-col items-center gap-y-6 sm:bg-inherit">
      <Image src="/tailboard-blue.svg" height={LOGO_SIZE} width={LOGO_SIZE} alt="Tailboard Logo" priority />
      <div className="input-box flex max-w-[572px] flex-col gap-y-2 rounded bg-white shadow">
        <h1 className="mb-7 overflow-visible text-2xl">Log in to Tailboard</h1>
        <div className="mb-3">
          <TextField
            label="Email"
            value={email}
        ...
        <div className="mb-2 mt-4 w-full">
          <Separator className={`border-tailboard-neutral-300 min-w-[300px] w-full`} text="or" />
          <Button
            className="mt-8 flex items-center gap-x-2"
            variant="outlined"
            sx={{ width: INPUT_WIDTH }}
            href="https://apps.apple.com/us/app/tailboard-uas/id1659888519"
            target="_blank"
          >
            <AppleIcon />
            <span className="relative top-[1px]">Download the App</span>
          </Button>
        </div>
