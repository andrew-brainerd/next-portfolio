...
export const Track = ({ className, name, artists, albumArt, onClick }: TrackProps) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      {albumArt && <img className="w-10 h-10 rounded flex-shrink-0 object-cover" src={albumArt} alt="" width={40} height={40} />}
